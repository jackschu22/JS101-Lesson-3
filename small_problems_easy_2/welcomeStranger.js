...
produce a person's name. The object will contain two keys, "title" and "occupation", 
...
function greetings(arr, obj) {
	let sentence1 = "Hello, " + arr.join(" ") + "! ";
	let sentence2 = "Nice to have a " + obj["title"] + " " 
									  + obj["occupation"] + ".";
	return sentence1 + sentence2;
}

/* can use string interpolatino to clean this up:
